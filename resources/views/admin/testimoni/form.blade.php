	...
	<div class="row">
		<div class="col-md-12 col-sm-12 col-xs-12">
			<div class="x_panel">
				<div class="row">
					<div class="x_content">
						<form action="{{  url('appweb/testimoni/create') }}" id="formtestimoni" class="form-horizontal form-bordered form-row-stripped" method="POST" enctype="multipart/form-data">
							@csrf
							...
							<div class="item form-group">
								<div class="col-md-4 col-md-offset-8">
									<a href="{{ url('appweb/testimoni') }}" class="btn btn-primary" name="back"><i class="fa fa-angle-left"></i> Back</a>
